...
const redirect_uri_client = `${process.env.NODE_ENV === 'production' ? process.env.PORT : 'http://localhost:3000'}/callback-client`; // Your redirect uri
const redirect_uri_server = `${process.env.NODE_ENV === 'production' ? process.env.PORT : 'http://localhost:3000'}/callback-server`; // Your redirect uri
