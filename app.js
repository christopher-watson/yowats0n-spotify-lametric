...
const redirect_uri_client = 'http://localhost:3000/callback-client'; // Your redirect uri
const redirect_uri_server = 'http://localhost:3000/callback-server'; // Your redirect uri
